...
//        Toast.makeText(ViewLocationsMapActivity.this, getIntent().getDoubleExtra("dLatitude", 0) + "", Toast.LENGTH_SHORT).show();
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(dLocation));
        ...
        LatLng pLocation = new LatLng(getIntent()
                .getDoubleExtra("pLatitude", 0),
                getIntent().getDoubleExtra("pLongitude", 0));
