...
public class SharePictureTab extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnPublish.setOnClickListener(SharePictureTab.this);
        ...
        switch (view.getId()) {
            ...
            case R.id.btnPublish:
                ...
                if (receivedImageBitmap != null) {
                        ...
                        parseObject.saveInBackground(new SaveCallback() {
                            ...
                            public void done(ParseException e) {
                                ...
                                if (e == null) {
                                    ...
                                    FancyToast.makeText(getContext(), "Unknown error: " + e.getMessage(), FancyToast.LENGTH_LONG, FancyToast.ERROR, true).show();
                    ...
                    FancyToast.makeText(getContext(), "you must select the image", FancyToast.LENGTH_LONG, FancyToast.ERROR, true).show();
                }
